...
<link href="<?php echo base_url();?>/public/template1/css/pages/signin.css" rel="stylesheet" type="text/css">
...
<script src="<?php echo base_url();?>/public/template1/js/signin.js"></script>
